...
function Home() {
  ...
  const selectCategory = [
    ...
    { name: "Entertainment: Music", label: "Entertainment: Music", value: "12" },
    { name: "Entertainment: Musicals & Theatres", label: "Entertainment: Musicals & Theatres", value: "13" },
    { name: "Entertainment: Television", label: "Entertainment: Television", value: "14" },
    { name: "Entertainment: Video Games", label: "Entertainment: Video Games", value: "15" },
    { name: "Entertainment: Board Games", label: "Entertainment: Board Games", value: "16" },
    { name: "Science & Nature", label: "Science & Nature", value: "17" },
    { name: "Science: Computers", label: "Science: Computers", value: "18" },
    { name: "Science: Mathematics", label: "Science: Mathematics", value: "19" },
    ...
    { name: "Entertainment: Comics", label: "Entertainment: Comics", value: "29" },
    { name: "Science: Gadgets", label: "Science: Gadgets", value: "30" },
    { name: "Entertainment: Japanese Anime & Manga", label: "Entertainment: Japanese Anime & Manga", value: "31" },
    { name: "Entertainment: Cartoon & Animations", label: "Entertainment: Cartoon & Animations", value: "32" }
  ];
